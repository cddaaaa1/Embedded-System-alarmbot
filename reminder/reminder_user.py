...
def add_reminder():
    ...
    response = requests.post(f"{SERVER_URL}/add_reminder", json={"task": task})
    print(response.json())
...
def mark_reminder_complete():
    ...
    response = requests.post(f"{SERVER_URL}/update_reminder", json={"task": task})
    print(response.json())

def delete_reminder():
    task = input("Enter the reminder to delete: ")
    response = requests.post(f"{SERVER_URL}/delete_reminder", json={"task": task})
    print(response.json())
